...
class MainViewModelTest {
    ...
    fun getTvShows() {
        ...
        assertEquals(dummyMovieTv.second.tvShow?.get(0)?.genres, tvShowEntity.tvShow?.get(0)?.genres)
    ...
    fun getMovies() {
        ...
        assertEquals(dummyMovieTv.first.movies?.get(0)?.genres, movieEntity.movies?.get(0)?.genres)
